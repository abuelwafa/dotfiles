...
require'nvim-treesitter'.install({
    ...
    'strace',
    'superhtml',
    -- ledger leo linkerscript liquid liquidsoap m68k matlab menhir meson mlir muttrc nasm nickel ninja nix nqc nu objdump ocaml ocaml_interface ocamllex odin pascal pioasm pkl poe_filter pony problog prolog properties proto prql psv pug puppet purescript pymanifest ql qmldir qmljs query r racket ralph rasi razor rbs re2c readline regex rego requirements rescript rifleconf rnoweb robot robots roc ron rst runescript t32 tablegen tact tcl teal turtle twig vento vhdl vhs vrl wing wxml xresources
})
vim.api.nvim_create_autocmd('FileType', {
    pattern = {
        'alloy', 'ansible', 'ant', 'apache', 'apachestyle', 'arduino', 'asciidoc',
        'asm', 'astro', 'autodoc', 'automake', 'awk', 'bash', 'basic', 'c', 'changelog',
        ...
        'terminfo', 'terraform', 'tf', 'tmux', 'toml', 'typescript',
